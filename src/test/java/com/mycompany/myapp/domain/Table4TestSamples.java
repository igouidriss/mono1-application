...
public class Table4TestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static Table4 getTable4Sample1() {
        return new Table4()
            .id(1L)
            .numLigne1(1)
            .resort2("resort21")
    ...
    public static Table4 getTable4Sample2() {
        return new Table4()
            .id(2L)
            .numLigne1(2)
            .resort2("resort22")
    ...
    public static Table4 getTable4RandomSampleGenerator() {
        return new Table4()
