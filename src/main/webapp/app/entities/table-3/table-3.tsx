  ...
  return (
    <div>
      <h2 id="table-3-heading" data-cy="Table3Heading">
        <Translate contentKey="mono1ApplicationApp.table3.home.title">Table 3 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="mono1ApplicationApp.table3.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-3/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="mono1ApplicationApp.table3.home.createLabel">Create new Table 3</Translate>
          </Link>
        </div>
      </h2>
        ...
        {table3List && table3List.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="mono1ApplicationApp.table3.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('descriptionTypeChbDeResv157')}>
                  <Translate contentKey="mono1ApplicationApp.table3.descriptionTypeChbDeResv157">
                ...
                <th className="hand" onClick={sort('circuitDistribUserRegroup161')}>
                  <Translate contentKey="mono1ApplicationApp.table3.circuitDistribUserRegroup161">
                ...
                <th className="hand" onClick={sort('descriptionTypeChbDeResv264')}>
                  <Translate contentKey="mono1ApplicationApp.table3.descriptionTypeChbDeResv264">
                ...
                <th className="hand" onClick={sort('circuitDistribUserRegroup268')}>
                  <Translate contentKey="mono1ApplicationApp.table3.circuitDistribUserRegroup268">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="mono1ApplicationApp.table3.home.notFound">No Table 3 S found</Translate>
            </div>
          )
        )}
      </div>
