    ...
    <Row>
      <Col md="8">
        <h2 data-cy="table4DetailsHeading">
          <Translate contentKey="mono1ApplicationApp.table4.detail.title">Table4</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="descriptionTypeChbDeResv157">
              <Translate contentKey="mono1ApplicationApp.table4.descriptionTypeChbDeResv157">Description Type Chb De Resv 157</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="circuitDistribUserRegroup161">
              <Translate contentKey="mono1ApplicationApp.table4.circuitDistribUserRegroup161">Circuit Distrib User Regroup 161</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="descriptionTypeChbDeResv264">
              <Translate contentKey="mono1ApplicationApp.table4.descriptionTypeChbDeResv264">Description Type Chb De Resv 264</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="circuitDistribUserRegroup268">
              <Translate contentKey="mono1ApplicationApp.table4.circuitDistribUserRegroup268">Circuit Distrib User Regroup 268</Translate>
            </span>
          </dt>
